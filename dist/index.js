...
var _spawn = require('./scripts/spawn');
...
var _log = require('./scripts/utils/log.utils');

var _log2 = _interopRequireDefault(_log);

var _preDeploy = require('./scripts/pre-deploy');

var _preDeploy2 = _interopRequireDefault(_preDeploy);

var _postDeploy = require('./scripts/post-deploy');
...
var suffix = void 0;
process.argv.includes('--commit-id') ? suffix = _config2.default.githubCommitId : suffix = _config2.default.githubSourceBranch;
